...
const publicIPs = [
  ...
  '2001:10::',
  '2001:10::ffff',
  '2001:10:ffff:ffff:ffff:ffff:ffff:ffff',
  '64:ff9a::0.0.0.0',
...
publicIPs.forEach(ip => assert(`IP ${ip.toString()} is NOT reserved ip`, t => t.false(isReservedIP(ip))))

reservedIPs.forEach(ip => assert(`IP ${ip.toString()} is reserved ip`, t => t.true(isReservedIP(ip))))

invalidIPs.forEach(ip => assert(`IP ${ip.toString()} is NOT ip`, t => t.is(isReservedIP(ip), undefined)))